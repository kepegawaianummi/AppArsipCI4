...
class Suratmasuk extends BaseController{
    ...
    public function delete($id = null){
        ...
        try{
          ...
          return redirect()->to(base_url('pages/suratmasuk'));
        } 
...
//return var_dump($sediakandata);
            ...
            $spreadsheet = $reader->load("template/tblsuratmasuk.xlsx");
        ...
        $filename = 'Laporan Surat Masuk'; // set filename for excel file to be exported
