...
?>
        <div class="ui-grid-a">
            <div class="ui-block-a">
                ...
                echo form_input('tgl_surat', date('d-m-Y',strtotime($suratkeluar->tgl_surat)),['placeholder'=>'Tanggal Surat','data-role'=>'date','data-mini'=>"true"]);
                echo form_input('tgl_diterima', date('d-m-Y',strtotime($suratkeluar->tgl_diterima)),['placeholder'=>'Tanggal Diterima','data-role'=>'date','data-mini'=>"true"]);
                echo form_dropdown('tahun_arsip',$options, "$suratkeluar->tahun_arsip",['placeholder'=>'Tahun Arsip','data-mini'=>"true"]);
                echo form_input('perihal_surat', "$suratkeluar->perihal_surat",['placeholder'=>'Perihal Surat','data-mini'=>"true"]);
                echo form_input('jenis_surat', "$suratkeluar->jenis_surat",['placeholder'=>'Jenis Surat','data-mini'=>"true"]);
                ?>
            </div>
             <div class="ui-block-b">
                <?php
                echo form_input('no_surat', "$suratkeluar->no_surat",['placeholder'=>'Nomor Surat','data-mini'=>"true"]);

echo form_input('instansi_asal', "$suratkeluar->instansi_asal",['placeholder'=>'Instansi Asal','data-mini'=>"true"]);
echo form_textarea('keterangan_surat', "$suratkeluar->keterangan_surat",['placeholder'=>'Keterangan Surat','data-mini'=>"true"]);
echo form_textarea('isi_surat', "$suratkeluar->isi_surat",['placeholder'=>'Isi Surat','data-mini'=>"true"]);
          ...
          <div class="ui-grid-solo">
            <div class="ui-block-a">
                ...
                echo form_dropdown('kd_bok', $opsibok,$suratkeluar->kd_bok,['placeholder'=>'Kode Bok','onchange'=>"carirak()",'id'=>"no_bok",'data-mini'=>"true"]);
                ...
                <option value="<?= $opsirak->kd_rak?>" <?php echo  $opsirak->kd_rak===$suratkeluar->kd_rak?'selected':'' ?>><?= $opsirak->kd_rak?> - <?= $opsirak->nama_rak?></option>
               <?php  endforeach;?>
            </select>
                <?php
                 echo "<label for='text-basic'>Warna Sampul:</label>";
                echo form_input('warna_sampul', "$suratkeluar->warna_sampul",['placeholder'=>'Warna Sampul','data-mini'=>"true"]);
                ?>
            </div>
        </div>  
<?php
