    ...
    <table id="tabelsuratmasuk" data-mini="true" data-role="table"  class="ui-body-d ui-shadow table-stripe ui-responsive" data-filter="true" data-input="#filterTable-input">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td >
                        <div data-role="controlgroup" data-type="horizontal" data-mini="true">
                <?=  anchor(site_url('Suratkeluar/delete/'.$surat->id), '', ['data-role'=>'button','class'=>'ui-shadow ui-corner-all ui-btn ui-corner-all ui-icon-delete ui-btn-icon-notext']); ?>               
                <?=  anchor(site_url("pages/editsuratkeluar/$surat->id"), '', ['data-role'=>'button','class'=>'uui-shadow ui-corner-all ui-btn ui-corner-all ui-icon-edit ui-btn-icon-notext','rel'=>'external']); ?>  
                    </div>
          </td>
            </tr>
            <?php endforeach; ?>
